...
const nombre =
  decodeURIComponent(params.get("nombre") || "Desconocido");

const monto =
  decodeURIComponent(params.get("monto") || "0");

const destino =
  decodeURIComponent(params.get("destino") || "Sin destino");
...
const numeroOperacion =
  Math.floor(4000000 + Math.random() * 1000000);
